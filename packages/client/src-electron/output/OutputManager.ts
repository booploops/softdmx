...
import type { ActiveChannel, ShowDocumentV1 } from "src/types";
import { DmxOutputDriver } from "./DmxOutputDriver";
import { GridNodeDriver } from "./GridNodeDriver";
import { ArtNetDriver } from "./ArtNetDriver";
import { SacnDriver } from "./SacnDriver";
import { DmxUsbProDriver } from "./DmxUsbProDriver";
import { ConfigFile } from "../config/configFile";
import { setHasGridnodeDestination } from "./gridnode-overlay";
import { getFixtureDefinition } from "src/plugins/fixture-lookup";
import type { UniverseHealthStatus } from "src/types/output-health";
import { createInitialHealth, updateHealthAfterSend } from "./output-health";
...
export class OutputManager {
  ...
  private showfile?: ShowDocumentV1;
  ...
  async updateDestinations(destinations: ShowDocumentV1['destinations']): Promise<void> {
  ...
  setShowfile(newShowfile: ShowDocumentV1): void {
  ...
  private recalculatePatches(showfile: ShowDocumentV1): void {
    this.patches.clear();

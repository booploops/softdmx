...
export function readGdtfAttributes(fixtureType: Record<string, unknown>) {
  const attributeDefinitions = fixtureType.AttributeDefinitions as
    | Record<string, unknown>
    | undefined;
  const attributesRoot = attributeDefinitions?.Attributes as Record<string, unknown> | undefined;
  return asArray(
    attributesRoot?.Attribute as Record<string, unknown> | Record<string, unknown>[] | undefined,
  );
}
...
export function readGdtfWheels(fixtureType: Record<string, unknown>) {
  ...
  return asArray(
    wheelsRoot?.Wheel as Record<string, unknown> | Record<string, unknown>[] | undefined,
  );
}
...
export function readGdtfModes(fixtureType: Record<string, unknown>) {
  ...
  return asArray(
    modesRoot?.DMXMode as Record<string, unknown> | Record<string, unknown>[] | undefined,
  );
}
...
export function readGdtfChannels(mode: Record<string, unknown>) {
  ...
  return asArray(
    channelsRoot?.DMXChannel as Record<string, unknown> | Record<string, unknown>[] | undefined,
  );
}
...
export function readChannelSets(logical: Record<string, unknown>) {
  ...
  for (const fn of functions) {
    const channelSets = asArray(
      fn.ChannelSet as Record<string, unknown> | Record<string, unknown>[] | undefined,
    );

...
import type { FixtureDefinition, FixtureChannelDefinition, WidgetConfiguration } from 'src/types/fixture';
  ...
  if (obj.attributes !== undefined) {
    ...
    attributes = obj.attributes.map((attribute, index) => {
      ...
      return {
        ...
        feature: ensureString(record.feature, `attributes[${index}].feature`) as import('src/types/attributes').AttributeFeature,
        merge: ensureString(record.merge, `attributes[${index}].merge`) as import('src/types/attributes').AttributeMerge,

...
export function themeTokensToCssVars(tokens: ThemeTokens): Record<string, string> {
  ...
  return {
    ...
    '--sdmx-color-plot-bg': colors.plotBackground,
    '--sdmx-color-plot-fixture': colors.plotFixture,
    '--sdmx-color-plot-selected': colors.plotSelected,
    '--sdmx-color-plot-grid': colors.plotGrid,
    '--sdmx-color-plot-center': colors.plotCenter,
    '--sdmx-color-plot-label': colors.plotLabel,
    // Typography
...
export const THEME_CSS_VAR_KEYS = [
  ...
  '--sdmx-color-plot-bg',
  '--sdmx-color-plot-fixture',
  '--sdmx-color-plot-selected',
  '--sdmx-color-plot-grid',
  '--sdmx-color-plot-center',
  '--sdmx-color-plot-label',

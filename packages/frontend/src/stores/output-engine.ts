...
export const useOutputEngineStore = defineStore('output-engine', () => {
  ...
  function syncPlaybackFromShow(show: ShowDocumentV1) {
  ...
  function applyGroupSubmasters(channels: ActiveChannel[], show: ShowDocumentV1) {
  ...
  function shouldUseTimecodeSetPlayback(show: ShowDocumentV1): boolean {

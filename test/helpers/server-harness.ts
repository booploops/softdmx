...
import { registerRemoteRestRoutes } from '../../src-electron/server/api/remote-rest.ts';
import {
...
import type { RemoteContext } from '../../src-electron/server/context.ts';
import { registerRemoteHandlers } from '../../src-electron/server/socket/remote.ts';
